...
var country_coder_exports = {};
__export(country_coder_exports, {
...
module.exports = __toCommonJS(country_coder_exports);
var import_which_polygon = __toESM(require("which-polygon"), 1);
...
function loadDerivedDataAndCaches(borders2) {
  ...
  borders2.features.forEach((feature2) => {
  ...
  function loadMembersForGroupsOf(feature2) {
    feature2.properties.groups.forEach((groupID) => {
      const groupFeature = featuresByCode[groupID];
  ...
  function cacheFeatureByIDs(feature2) {
    ...
    (feature2.properties.aliases || []).forEach((alias) => {
      ids.push(alias);
    });
    ids.forEach((id) => {
      let cid = canonicalID(id);
      featuresByCode[cid] = feature2;
    });
  }
}
...
function featuresContaining(query, strict) {
  ...
  matchingFeatures.forEach((feature2) => {
...
//# sourceMappingURL=country-coder.cjs.map
